...
_MODEL_REGISTRY: dict[str, ModelSpec] = {
    ...
    # GGUF (native Q8_0 / K-quants) qwen35moe (Qwen3.5-style hybrid MoE: GDN linear
    # layers + gated full attention, routed + shared experts): same model classes,
    # GGUF config + weight loaders.
